import {Filters, PostType} from "./types"
...
export type FiltersActionTypes = filterByState | filterByLatest | getTypes | getGenres | PostPet | getPosts | getDetail | getPostQuery | applyFilters
