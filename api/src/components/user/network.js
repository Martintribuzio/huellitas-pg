          ...
          user.save((err, user) => {
            if (err) {
              ...
              const user = {
                ...
                instagram: req.user.instagram ? req.user.instagram : null,
                address: req.user.address ? req.user.address : null,
                website: req.user.website ? req.user.website : null,
                description: req.user.description ? req.user.description : null,
              };
